...
esp_err_t es8311_init(es8311_handle_t dev, const es8311_clock_config_t *const clk_cfg, const es8311_resolution_t res_in, const es8311_resolution_t res_out)
{
    ...
    //ESP_RETURN_ON_ERROR(es8311_write_reg(dev, ES8311_SYSTEM_REG13, 0x50), TAG, "I2C read/write error"); //– enable output to HP drive
    ESP_RETURN_ON_ERROR(es8311_write_reg(dev, ES8311_SYSTEM_REG13, 0x40), TAG, "I2C read/write error"); //–default for line out drive (default)
    ...
    ESP_RETURN_ON_ERROR(es8311_write_reg(dev, ES8311_DAC_REG34, 0x80), TAG, "I2C read/write error");//drc on/off
    ESP_RETURN_ON_ERROR(es8311_write_reg(dev, ES8311_DAC_REG35, 0xF0), TAG, "I2C read/write error");//drc setting
